...
do
    ...
    --ppo_epoch 10 --use_ReLU --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --use_wandb --competitive --share_policy --adversary_training_interval 50 --good_agent_training_interval 25
done