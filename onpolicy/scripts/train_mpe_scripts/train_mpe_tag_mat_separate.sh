...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=0 python /Users/jerry/Desktop/01/School/Research\ Project/mappo/onpolicy/scripts/train/train_mpe.py --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} \
